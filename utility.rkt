...
(define-syntax (define-helper-funcs stx)
  (syntax-case stx ()
               ([define-helper-funcs curve]
                (with-syntax (
                              ; functions came from modulo-arith
                              [elliptic-curve-p (datum->syntax stx 'elliptic-curve-p)]
                              [inverse-of (datum->syntax stx 'inverse-of)]
                              ...
                              [scalar-mul (datum->syntax stx 'scalar-mul)]
                              ; helper functions to be defined
                              [mod (datum->syntax #'define-helper-funcs 'mod)]
                              [inv (datum->syntax #'define-helper-funcs 'inv)]
                              [sqr   (datum->syntax #'define-helper-funcs 'sqr)]
                              [pow   (datum->syntax #'define-helper-funcs 'pow)]
                              [sqrt  (datum->syntax #'define-helper-funcs 'sqrt)]
                              [+     (datum->syntax #'define-helper-funcs '+)]
                              [-     (datum->syntax #'define-helper-funcs '-)]
                              [*     (datum->syntax #'define-helper-funcs '*)]
